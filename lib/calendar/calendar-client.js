  ...
  async testConnection() {
    try {
      ...
      if (error.message.includes("invalid_grant")) {
        ...
        console.log(
          "2. Follow the prompts to regenerate your Google OAuth tokens"
        );
        console.log("3. Update your .env file with the new tokens");
        console.log("4. Try running this command again");
      } else if (error.message.includes("invalid_client")) {
        console.log("\n🔧 To fix this issue:");
        console.log("1. Check your Google Cloud Console OAuth credentials");
        console.log("2. Verify CLIENT_ID and CLIENT_SECRET in your .env file");
        console.log("3. Run: node setup-oauth.js to regenerate tokens");
      } else {
        console.log("\n🔧 To fix token issues:");
        console.log("Run: node setup-oauth.js");
      }
